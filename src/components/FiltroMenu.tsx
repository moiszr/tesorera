    ...
    <>
      <button
        ...
        className={[
          ...
          activo
            ? 'border-accion bg-[rgba(138,51,64,0.08)] font-medium text-accion'
      ...
      >
        ...
        {activo && permiteTodas ? (
          <span
            ...
            className="-mr-1 flex h-7 w-7 shrink-0 cursor-pointer items-center justify-center rounded-full transition-colors hover:bg-[rgba(138,51,64,0.16)]"
          >
            <IconoCerrar tam={14} />
          </span>
        ) : (
  ...
  return (
    <button
      ...
      className={[
        ...
        elegida ? 'bg-[rgba(138,51,64,0.08)] font-medium text-accion' : 'hover:bg-hoja2',
      ].join(' ')}
    >
      {children}
    </button>
