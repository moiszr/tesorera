        ...
        <div className="hoja overflow-hidden">
          {!elegida ? (
            ...
            <form onSubmit={guardar} className="p-5">
              ...
              {problema && <p className="mt-2 text-menuda text-accion">{problema}</p>}
                    ...
                    {METODOS.map((m) => (
                      <button
                        ...
                        className={[
                          ...
                          metodo === m.valor
                            ? 'border-accion bg-[rgba(37,99,235,0.09)] text-accion'
    ...
    <div>
      ...
      {editando ? (
        <input
          ...
          className="w-full min-h-[46px] rounded-pieza border border-accion bg-hoja px-3 focus:outline-none focus:ring-2 focus:ring-[rgba(37,99,235,0.18)]"
        />
      ) : (
        <button
          type="button"
      ...
      <div className="border-b border-linea p-5 pb-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-pieza border border-lineaFuerte bg-hoja2 py-3 pl-11 pr-4 text-guia transition-colors duration-150 placeholder:text-tinta3 focus:border-accion focus:outline-none focus:ring-2 focus:ring-[rgba(37,99,235,0.18)]"
          />
        </div>
