...
import { Aviso, Boton, EstadoVacio, EtiquetaIglesia, Monto } from '../components/Piezas'
      ...
      <div className="hoja overflow-hidden">
        ...
        <div className="px-6 pb-5 pt-6">
          ...
          {excedente > 0 && (
            <div className="mt-3">
              <Aviso>
                De lo recaudado, <span className="cifra font-medium">{formatoRD(excedente)}</span> son pagos
